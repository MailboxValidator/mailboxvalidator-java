...
myst_html_meta = {
    "description": "MailboxValidator Java module enable users to block disposal email, detect free email and validate if an email is valid.",
    "keywords": "MailboxValidator, Email Validation, disposable email, free email, Java",
...
html_title = "MailboxValidator Java"
